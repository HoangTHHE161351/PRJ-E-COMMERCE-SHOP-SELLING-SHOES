                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="homeAdmin" class="breadcrumb-link">Dashboard</a></li>
                                        ...
                                        <div class="card-body ">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" required="" name="productCode" value="${product.productCode}" placeholder="ProductID" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Productname</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" required="" name="productName" value="${product.productName}" placeholder="Productname" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                    <input id="Price" type="Price" name="price" required="" value="${product.priceFormat}" placeholder="Price" class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input value="${product.status}" name="status" required="" placeholder="Phone" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Quantity</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input value="${product.quantity}" name="quantity" required="" placeholder="Phone" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control custom-radio">
                                                        <input type="radio" name="gender" value="1" ${product.gender == 1 ? 'checked' : ''}  class="custom-control-input"><span class="custom-control-label">Male</span>
                                                    </label>
                                                    <label class="custom-control custom-radio">
                                                        <input type="radio" name="gender" value="0" ${product.gender == 0 ? 'checked' : ''} class="custom-control-input"><span class="custom-control-label">Female</span>
                                                    </label>
                                                    <label class="custom-control custom-radio">
                                                        <input type="radio" name="gender" value="2" ${product.gender == 2 ? 'checked' : ''} class="custom-control-input"><span class="custom-control-label">UniSex</span>
                                                    </label>
