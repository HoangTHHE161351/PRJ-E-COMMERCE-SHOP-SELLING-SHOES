<%-- 
    ...
    Created on : Oct 28, 2022, 10:50:00 AM
    Author     : DELL
--%>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                <c:forEach items="${productList}" var="p">
                                                    <tr>
                                                        <td>${p.productCode}</td>
                                                        <td><img width="50px" src="${p.image.image1}" alt="alt"/></td>
                                                        <td>${p.productName}</td>
                                                        ...
                                                        <td>${p.status}</td>
                                                        <td>
                                                            <a href="adminViewProduct?code=${p.productCode}"><button class="btn btn-sm btn-outline-light">Edit</button></a>
                                                            <a href="deleteProduct?code=${p.productCode}"><button class="btn btn-sm btn-outline-light">
                                    ...
                                    <a href="adminAddProduct" class="btn btn-primary">Add Product</a>
                                </div>                       
                            </div>                       
                        </div>
                        <!-- ============================================================== -->
