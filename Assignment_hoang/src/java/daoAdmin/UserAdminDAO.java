...
//            if(rs.next()){
////                return new User(rs.getString(1), rs.getString(2), rs.getString(7), rs.getString(5), rs.getString(6), rs.getString(3), rs.getString(4), rs.getString(8), rs.getDate(9));
//            }
...
//            ResultSet rs = st.executeQuery();
//            while(rs.next()){
//                list.add(new User(rs.getString(1), rs.getString(2), rs.getString(7), rs.getString(5), rs.getString(6), rs.getString(3), rs.getString(4), rs.getString(8), rs.getDate(9)));
//            }
//        }catch(SQLException e){
//            System.out.println(e);
//        }
